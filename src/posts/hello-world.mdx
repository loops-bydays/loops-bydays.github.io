...
abstract: I originally built this portfolio site back in 2022, and since then it's evolved quite a bit. Recently I migrated from Create React App to Next.js and made some major upgrades in the process.
date: '2022-04-21'
